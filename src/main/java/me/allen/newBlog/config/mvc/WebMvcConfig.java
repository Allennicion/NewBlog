...
import me.allen.newBlog.config.filter.AdminFilter;
import me.allen.newBlog.config.filter.InitFilter;
import me.allen.newBlog.config.filter.SessionFilter;
import me.allen.newBlog.config.filter.TokenFilter;
...
/**
 * created by allen on 2019/3/15 at 21:21
 *
 * @author allen
 */
@Configuration
