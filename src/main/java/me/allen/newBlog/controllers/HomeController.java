...
import me.allen.newBlog.service.*;
...
public class HomeController extends BaseController {
    ...
    public ResultBeanObj checkUpdate(String clientVersion) {
        ...
        if (StrUtil.isNotEmpty(clientVersion) && !serverVersion.equals(clientVersion)) {
            return ResultBeanObj.ok("检测到更新，最新版本【" + serverVersion + "】请前往<a href='https://allen.me/article/u/newBlog_upadtes' target='_blank'>【此处】</a>更新");
        } else {
